...
<form class="form form-vertical" action="{{ route('admin.role.store') }}" method="POST">
    @csrf
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="@lang('form.role.placeholder.name')" value="{{ old('name') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
