        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="@lang('form.page.placeholder.name')" value="{{ old('name') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="label">@lang('form.page.label')</label>
                    <input type="text" id="label" name="label" class="form-control" placeholder="@lang('form.page.placeholder.label')" value="{{ old('label') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="route" name="route" class="form-control" placeholder="@lang('form.page.placeholder.route')" value="{{ old('route') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="icon">@lang('form.page.icon')</label>
                    <input type="text" id="icon" name="icon" class="form-control" placeholder="@lang('form.page.placeholder.icon')" value="{{ old('icon') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="permission">@lang('form.page.permission')</label>
                    <input type="text" id="permission" name="permission" class="form-control" placeholder="@lang('form.page.placeholder.permission')" value="{{ old('permission') }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
