        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="Page Name" value="{{ old('name', $page->name) }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="label">@lang('form.page.label')</label>
                    <input type="text" id="label" name="label" class="form-control" placeholder="Page Label" value="{{ old('label', $page->label) }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="route" name="route" class="form-control" placeholder="Page Route" value="{{ old('route', $page->route) }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="icon">@lang('form.page.icon')</label>
                    <input type="text" id="icon" name="icon" class="form-control" placeholder="Page Icon" value="{{ old('icon', $page->icon) }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
                    <label for="permission">@lang('form.page.permission')</label>
                    <input type="text" id="permission" name="permission" class="form-control" placeholder="Page Permission" value="{{ old('permission', $page->permission) }}" required autofocus>
                </div>
            </div>
            <div class="col-12">
